...
export const manifest: Partial<ManifestOptions> = {
	name: "Astro Diet Tracker", // Change this to your website's name.
	short_name: "Diet Tracker", // Change this to your website's short name.
	description:
		"Diet Tracker app that helps you to track the food you eat", // Change this to your websites description.
